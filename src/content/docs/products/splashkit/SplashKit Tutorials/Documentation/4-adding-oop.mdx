...
One of the current goals of the Splashkit team is to add both top level statement and OOP versions of C# programs to the Splashkit tutorials. This guide shows how to add OOP to the Splashkit tutorials.
